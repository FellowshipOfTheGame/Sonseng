...
public class MyPlayerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (_percentageProp.arraySize != _stageNumberProp.intValue-1 && _stageNumberProp.intValue > 0)
        {
        ...
        {
            EditorGUILayout.PropertyField(_percentageProp.GetArrayElementAtIndex(i), new GUIContent($"% for Stage {i + 1}"));
        }
